...
class MessageAdapter(context: Context, messageList: List<BaseMessage>, type: String?) : RecyclerView.Adapter<RecyclerView.ViewHolder>(), StickyHeaderAdapter<DateItemHolder?> {
 ...
 //       Log.v("TAG99","data :${baseMessage.rawMessage.getJSONObject("data")}")
//        val data = baseMessage.rawMessage.getJSONObject("data")

//        if(data != null && data.get("action") == "joined"){
...
//            intent.putExtra(StringContract.IntentStrings.PARENT_BASEMESSAGE,baseMessage.toString());
                ...
                try {
                    ...
                    for (k in 0 until options.length()) {
                        ...
                        textViewOption.setTextAppearance(context, com.google.android.material.R.style.TextAppearance_AppCompat_Medium)
                        textViewPercentage.setTextAppearance(context, com.google.android.material.R.style.TextAppearance_AppCompat_Medium)
...
//            intent.putExtra(StringContract.IntentStrings.PARENT_BASEMESSAGE,baseMessage.toString());
    ...
    private fun setActionData(view: ActionMessageViewHolder, i: Int) {
        val baseMessage = messageList[i]
        Log.v("TAG999","data :${baseMessage.rawMessage.getJSONObject("data")}")
...
//                val txtMessage = baseMessage.text.trim { it <= ' ' }
                ...
                viewHolder.view.goTxtMessage.setLinkTextColor(context.resources.getColor(R.color.blue))
                ...
                Linkify.addLinks( viewHolder.view.goTxtMessage, Linkify.WEB_URLS)
                Linkify.addLinks( viewHolder.view.goTxtMessage, Linkify.ALL)
...
//                    viewHolder.view.txtTime.visibility = View.GONE
                ...
                viewHolder.view.goTxtMessage.setOnLongClickListener {
                //    Toast.makeText(context,"2679",Toast.LENGTH_SHORT).show()
...
//                else viewHolder.view.txtTime.visibility = View.GONE
                ...
                viewHolder.view.goTxtMessage.setOnLongClickListener {
                 //   Toast.makeText(context,"2845",Toast.LENGTH_SHORT).show()
                    if (!isImageMessageClick) {
                        isLongClickEnabled = true
                        isTextMessageClick = true
                        setLongClickSelectedItem(baseMessage)
        ...
        if (baseMessage.deletedAt == 0L) {
            ...
            if (baseMessage.category == CometChatConstants.CATEGORY_MESSAGE) {
                ...
                if (baseMessage.category == CometChatConstants.CATEGORY_ACTION) {
                    Log.v("TAG11","3470")
                    if (baseMessage is Action && false) {
