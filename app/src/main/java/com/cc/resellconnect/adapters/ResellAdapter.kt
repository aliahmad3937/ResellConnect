...
class ResellAdapter(
    ...
    ) : RecyclerView.Adapter<ResellViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResellViewHolder {
        return ResellViewHolder(
    ...
    override fun onBindViewHolder(holder: ResellViewHolder, position: Int) {
...
class ResellViewHolder(val mBinding: ItemSneakerBinding) : RecyclerView.ViewHolder(mBinding.root)