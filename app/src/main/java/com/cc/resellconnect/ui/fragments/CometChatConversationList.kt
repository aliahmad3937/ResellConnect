...
class CometChatConversationList : Fragment(), TextWatcher {
   ...
   // private var ivStartConversation: ImageView? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        tvChannel = vw!!.findViewById(R.id.tv_channel)
        tvDm = vw!!.findViewById(R.id.tv_dm)
        layoutChannel = vw!!.findViewById(R.id.layout_channel)
        layoutDm = vw!!.findViewById(R.id.layout_dm)
        v_channel = vw!!.findViewById(R.id.v_1)
        v_dm = vw!!.findViewById(R.id.v_2)
...
//        }
        ...
        vw!!.findViewById<ImageView>(R.id.create_group).setOnClickListener(View.OnClickListener { view1: View? ->
...
//           startActivity(intent)
        ...
        vw!!.findViewById<ImageView>(R.id.chat_rule)
        ...
        layoutChannel.setOnClickListener {
            ...
            changeLayout()
            try {
                findNavController().navigate(com.cc.resellconnect.R.id.action_cometChatConversationList_to_cometChatGroupList)
            }catch(e:Exception){
                findNavController().navigate(com.cc.resellconnect.R.id.action_cometChatUserList_to_cometChatGroupList)
            }
        ...
        layoutDm.setOnClickListener {
          ...
          //  findNavController().navigate(com.cc.resellconnect.R.id.cometChatConversationList)
        }
    ...
    fun changeLayout() {
        if (MyApplication.isChannel) {
            tvChannel.setTextColor(mContext.getColor(com.cc.resellconnect.R.color.black))
            tvDm.setTextColor(mContext.getColor(com.cc.resellconnect.R.color.grey))
            v_channel.visibility = View.VISIBLE
            v_dm.visibility = View.INVISIBLE

        } else {
            tvChannel.setTextColor(mContext.getColor(com.cc.resellconnect.R.color.grey))
            tvDm.setTextColor(mContext.getColor(com.cc.resellconnect.R.color.black))
        ...
        conversationsRequest?.fetchNext(object : CallbackListener<List<Conversation>>() {
            override fun onSuccess(conversations: List<Conversation>) {
                ...
                if (conversations.isNotEmpty()) {
                    val list2 = mutableListOf<Conversation>()
                    for(i in conversations){
                        if(i.conversationType == "user"){
                            list2.add(i)
                        }
                        Log.v("TAG111","conversation :${i.conversationType}")
                    }
                    if(list2.isNotEmpty()){
                        stopHideShimmer()
                        noConversationView?.visibility = View.GONE
                        rvConversation?.setConversationList(list2)
    ...
    private fun addConversationListener() {
        ...
        addGroupListener(TAG, object : GroupListener() {
            ...
            override fun onGroupMemberLeft(action: Action, leftUser: User, leftGroup: Group) {
                ...
                if (leftUser.uid == getLoggedInUser().uid) {
